...
注意: Google 等网站请通过 https 方式访问，如 https://www.google.com/ncr 或者 https://www.google.com.hk 避免因响应http请求时的重置连接。这几版的hosts其实就是针对系统增删了专门的网址，使用的专门类型的IP地址，还有转换了换行符（为了方便各位直接拿到就能用)。
